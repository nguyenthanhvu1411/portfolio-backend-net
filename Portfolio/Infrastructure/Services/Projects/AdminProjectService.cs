...
public sealed class AdminProjectService : IAdminProjectService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var items = await query
            ...
            .Select(x => new ProjectDto
            {
                ...
                ThumbnailUrl = x.ThumbnailUrl ?? x.ProjectImages.OrderByDescending(i => i.IsThumbnail).ThenBy(i => i.DisplayOrder).ThenBy(i => i.Id).Select(i => i.ImageUrl).FirstOrDefault(),
    ...
    private static ProjectDto MapSummary(Project project)
    {
        return new ProjectDto
        {
            ...
            ThumbnailUrl = project.ThumbnailUrl ?? project.ProjectImages.OrderByDescending(i => i.IsThumbnail).ThenBy(i => i.DisplayOrder).ThenBy(i => i.Id).Select(i => i.ImageUrl).FirstOrDefault(),
